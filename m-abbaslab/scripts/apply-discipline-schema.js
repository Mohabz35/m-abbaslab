...
;(async () => {
  const raw = fs.readFileSync(path.join(__dirname, '..', 'supabase', 'discipline_analytics_schema.sql'), 'utf8')
  ...
  try {
    ...
    console.log(`Discipline/Analytics schema: ${ok} applied, ${skip} skipped, ${fail} failed`)
  } finally {
    client.release()
    await pool.end()
  }
