    ...
    <div className="min-h-screen bg-black text-white p-8 font-mono relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <header className="flex justify-between items-center mb-12 border-b border-gray-200 dark:border-gray-700 border-white/10 pb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">System Administrator: {personalConfig.name}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 bg-white dark:bg-gray-800/5 border border-gray-200 dark:border-gray-700 border-white/10 rounded-xl p-6">
            <h2 className="text-xl font-bold mb-6 flex items-center">
              <Database className="w-5 h-5 mr-2 text-blue-400" />
              System Status
            </h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-black/40 rounded-lg border border-gray-200 dark:border-gray-700 border-white/5">
                <div className="flex items-center">
                  <div className={`w-2 h-2 ${dbStatus === 'connected' ? 'bg-green-500' : 'bg-yellow-500'} rounded-full mr-3`} />
                  <span>Supabase Database</span>
                </div>
                <span className="text-xs font-mono text-gray-500 dark:text-gray-400">{hasSupabaseKeys ? 'Connected' : 'No Keys'}</span>
              ...
              <div className="flex items-center justify-between p-4 bg-black/40 rounded-lg border border-gray-200 dark:border-gray-700 border-white/5">
                ...
                <span className="text-xs font-mono text-gray-500 dark:text-gray-400">Three.js / R3F</span>
              ...
              <div className="flex items-center justify-between p-4 bg-black/40 rounded-lg border border-gray-200 dark:border-gray-700 border-white/5">
                ...
                <span className="text-xs font-mono text-gray-500 dark:text-gray-400">Port 3009</span>
                <span className="px-2 py-1 bg-green-500/10 text-green-400 text-xs rounded">ACTIVE</span>
              </div>
            </div>
          </div>

          <div className="bg-white dark:bg-gray-800/5 border border-gray-200 dark:border-gray-700 border-white/10 rounded-xl p-6">
            <h2 className="text-xl font-bold mb-6 flex items-center">
            ...
            <div className="space-y-3">
              ...
              <a href="/admin/dashboard" className="block w-full text-center py-3 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:bg-gray-800 text-black rounded-lg transition-colors font-bold flex items-center justify-center gap-2">
