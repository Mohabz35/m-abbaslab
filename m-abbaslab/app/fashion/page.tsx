                  ...
                  <div className="absolute inset-0 z-20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/30">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div className="flex gap-2">
                        <a
                          href={`https://www.instagram.com/share?url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.origin + '/fashion' : 'https://m-abbaslab.com/fashion')}`}
                          target="_blank"
                        ...
                        <a
                          href={`https://api.whatsapp.com/send?text=${encodeURIComponent('Check out this fashion portfolio! ' + (typeof window !== 'undefined' ? window.location.origin + '/fashion' : 'https://m-abbaslab.com/fashion'))}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          onClick={e => e.stopPropagation()}
                        ...
                        <a
                          href={`https://www.tiktok.com/share?url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.origin + '/fashion' : 'https://m-abbaslab.com/fashion')}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          onClick={e => e.stopPropagation()}
                        ...
                        <a
                          href={`https://substack.com/share?publication_url=&p=${encodeURIComponent(typeof window !== 'undefined' ? window.location.origin + '/fashion' : 'https://m-abbaslab.com/fashion')}&utm_source=substack`}
                          target="_blank"
                          rel="noopener noreferrer"
                          onClick={e => e.stopPropagation()}
