// config/personal.ts - AUTOMATICALLY UPDATED BY ADMIN PANEL
export const personalConfig = {
  "name": "Mohammed Abbas",
  "brandName": "M-AbbasLab",
  "title": "Economist | Statistician | Data Scientist | Fashion Model",
  ...
  "projects": [
    {
      "id": "m-abbas-ai",
      "title": "M-Abbas AI — Interactive Cyborg",
      "description": "A biomimetic android that is an exact physical replica of me, powered by a multimodal large action model, motion capture movement library, and compliant robotic actuators.",
      "longDescription": "The M-Abbas AI is a conceptual blueprint for a biomimetic android — an exact physical replica, created from a full 3D body scan. It features a flexible silicone skin with hyper-realistic micro-expressions, high-resolution camera eyes with natural saccadic movement, and a cloned voice with natural prosody.\n\nThe structure uses series elastic actuators (SEAs) for compliant, human-like movement, a full motion-capture library of my personal gestures and gait, and a dynamic balancing engine for natural walking and recovery.\n\nThe intelligence layer fuses multimodal sensory data — vision (facial expression tracking), audio (emotion detection), and tactile (touch force sensing) — into a central Large Action Model that generates linguistically, prosodically, and kinesically synchronized responses. The system learns continuously from every interaction.",
      "technologies": [
        "Robotics",
  ...
  "fashion": {
    ...
    "representation": [
      {
        "name": "Talent Pool Africa",
        "type": "Commercial",
        "since": "2022"
      },
      {
        "name": "Kitui Models Association",
        "type": "Local",
        "since": "2021"
      },
      {
