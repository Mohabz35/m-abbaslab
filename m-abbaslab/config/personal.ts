// config/personal.ts - COMPLETE DATA WITH ALL PROJECTS & TITLES
export const personalConfig = {
  // === CORE IDENTITY ===
  name: "Mohammed Abbas",
  brandName: "M-AbbasLab",
  title: "Model | Brand Ambassador | Title Holder| Fashion Advocate",
  ...
  social: {
    ...
    twitter: "https://x.com/MohabzMabz",
    instagram: "https://www.instagram.com/mohabmabz/",
    tiktok: "https://www.tiktok.com/@mohammed_abbas35",
    facebook: "https://www.facebook.com/share/1BYwGqSfCF/",
    youtube: "https://youtube.com/@mohammedabbas-c6j?si=e2T44v7yJOKpBMx-",
    whatsapp: "https://wa.me/254700000000", // Update with actual number if provided or keep generic
    telegram: "https://t.me/mohabz35"
  },

  // === ROLES & INTERESTS ===
  roles: ["Student", "Engineer", "Researcher", "Model"],
  researchInterests: [
  ...
  projects: [
    {
      ...
      technologies: ["Next.js 14", "TypeScript", "Tailwind CSS", "Framer Motion", "Supabase", "WebGL", "Three.js"],
    ...
    },
    {
      ...
      technologies: ["React", "Node.js", "Python", "Machine Learning", "GraphQL", "PostgreSQL", "D3.js"],
      github_url: "#",
      live_url: "#",
    ...
    },
    {
      ...
      technologies: ["Python", "TensorFlow", "Economics", "ML", "Pandas", "Docker"],
      github_url: "#",
      live_url: "#",
      category: "research",
      featured: true,
    ...
    },
    {
      ...
      technologies: ["React", "D3.js", "TypeScript", "Next.js", "WebSocket"],
      github_url: "#",
      live_url: "#",
      category: "technology",
      featured: true,
    ...
    },
    {
      ...
      technologies: ["R", "Statistics", "Research", "Economics", "Shiny"],
      github_url: "#",
      live_url: "#",
      category: "analysis",
      featured: true,
    ...
    },
    {
      ...
      technologies: ["Python", "NLP", "Sentiment Analysis", "Finance", "FastAPI"],
      github_url: "#",
      live_url: "#",
      category: "research",
      featured: false,
    ...
    },
    {
      ...
      technologies: ["Next.js", "WebSocket", "Real-time", "Chart.js", "Redis"],
      github_url: "#",
      live_url: "#",
      category: "technology",
      featured: false,
    ...
    },
    {
      ...
      technologies: ["R", "Healthcare", "Statistics", "Data", "Tableau"],
      github_url: "#",
      live_url: "#",
      category: "analysis",
      featured: false,
    ...
    },
    {
      ...
      technologies: ["Research", "System Design", "Data Analysis", "Educational Tech", "UI/UX"],
      github_url: "#",
      live_url: "#",
      category: "research",
      featured: true,
    ...
    },
    {
      ...
      technologies: ["Python", "React", "D3.js", "Financial APIs", "Data Visualization", "Statistics"],
      github_url: "#",
      live_url: "#",
    ...
    },
    {
      ...
      technologies: ["Next.js", "3D Modeling", "WebGL", "Fashion Tech", "Data Analytics"],
      github_url: "#",
      live_url: "#",
    ...
    },
    {
      ...
      technologies: ["Python", "Jupyter", "Statistics", "Econometrics", "Data Science"],
      github_url: "#",
      live_url: "#",
      category: "data-science",
      featured: false,
    ...
    },
    {
      ...
      technologies: ["Go", "gRPC", "Redis", "Docker", "Kubernetes", "Nginx"],
      github_url: "#",
      live_url: "#",
      category: "technology",
      featured: true,
  ...
  articles: [
    ...
    },
    {
      ...
      content: "Full article content about AI in fashion...",
      category: "research",
      read_time: 15,
      published: true,
      published_at: "2024-01-10T10:30:00Z",
      tags: ["AI", "Fashion Tech", "Modeling", "Innovation"],
      featured: true
    },
    {
      ...
      content: "Full article content about quantitative finance...",
      category: "economics",
      read_time: 18,
      published: true,
      published_at: "2024-01-05T10:30:00Z",
      tags: ["Finance", "Quantitative", "Economics", "Python"]
    },
    {
      ...
      content: "Full article content about modeling and tech...",
      category: "fashion",
      read_time: 10,
      published: true,
      published_at: "2023-12-20T10:30:00Z",
      tags: ["Modeling", "Technology", "Fashion", "Innovation"]
    },
    {
      ...
      content: "Full article content about statistical modeling...",
      category: "data-science",
      read_time: 14,
      published: true,
      published_at: "2023-12-15T10:30:00Z",
      tags: ["Statistics", "Data Science", "Tutorial", "Python"]
    },
    {
      id: "webgl-3d-web",
      ...
      content: "Full article content about WebGL and 3D web...",
      category: "tutorial",
      read_time: 20,
      published: false,
      published_at: null,
      tags: ["WebGL", "Three.js", "3D", "Web Development"]
    },
    {
      ...
      content: "Full article content about AI monetary policy...",
      category: "research",
      read_time: 25,
      published: true,
      published_at: "2024-01-25T10:30:00Z",
      tags: ["AI", "Economics", "Monetary Policy", "Future Tech"],
      featured: true
    },
    {
      ...
      content: "Full article content about sustainable fashion analytics...",
      category: "fashion-tech",
      read_time: 15,
      published: true,
      published_at: "2024-01-20T10:30:00Z",
      tags: ["Fashion Tech", "Sustainability", "Data Science", "AI"]
    },
    {
      ...
      content: "Full article content about asset tokenization...",
      category: "economics",
      read_time: 18,
      published: true,
      published_at: "2024-01-28T10:30:00Z",
      tags: ["Blockchain", "Economics", "Emerging Markets", "FinTech"]
    },
    {
      ...
      content: "Full article content about API scalability...",
      category: "technical",
      read_time: 12,
      published: true,
      published_at: "2024-02-01T10:30:00Z",
      tags: ["API Design", "System Architecture", "Backend", "Scalability"]
    },
    {
      ...
      tags: ["Security", "API", "Cybersecurity", "Best Practices"]
    }
  ],
  ...
  fashion: {
    ...
    // Modeling Categories
    categories: [
      { id: "editorial", name: "Editorial", count: 8 },
      { id: "commercial", name: "Commercial", count: 12 },
      { id: "runway", name: "Runway", count: 6 },
      { id: "portfolio", name: "Portfolio", count: 15 }
    ],

    // Agencies & Representation
    representation: [
      { name: "Talent Pool Africa", type: "Commercial", since: "2022" },
      { name: "Kitui Models Association", type: "Local", since: "2021" },
      { name: "Freelance", type: "Independent", since: "2020" }
    ],
  ...
  // === FASHION MODELING TITLES & ACHIEVEMENTS ===
  modelingTitles: [
    {
      id: "mr-youth-youth",
      ...
      details: [
        ...
        "Organized community tech workshops"
      ]
    },
    {
      id: "mr-glam-haven",
      ...
      details: [
        ...
        "Showcased contemporary fashion trends"
      ]
    },
    {
      id: "mr-kitui-got-talent",
    ...
    },
    {
      ...
      details: [
        ...
        "Featured in county tourism promotions"
      ]
    },
    {
      id: "mr-kipawa-afrika",
  ...
  runwayJourney: [
    {
      ...
      highlights: ["Skill Development", "Confidence Building", "First Runway Steps"]
    },
    {
      ...
      highlights: ["Mr. Alba Hotel (1st Runner-Up)", "Commercial Modeling", "Brand Representation"]
    },
    {
      ...
      highlights: ["Mr. YYMH Winner", "Youth Ambassador", "Community Leadership"]
    },
    {
      id: "uni-advancement",
      year: "2025/2026",
      ...
      highlights: ["Mr. Glam Haven Winner", "Male Beauty Icon", "Professional Grooming"]
    },
    {
      id: "talent-industry",
      year: "2025/2026",
      ...
      highlights: ["Mr. Kitui Got Talent Winner", "Talent Empowerment", "Industry Builder"]
    },
    {
      ...
      highlights: ["Elite Runway Competition", "High Fashion Standards", "Professional Exposure"]
    },
    {
      id: "county-crown",
      year: "2025/2026",
      ...
      highlights: ["Mr. Fashion Kitui County Winner", "Fashion Identity Title", "Top Male Model"]
    },
    {
      ...
      highlights: ["Model Judge", "Industry Professional", "Pageant Authority"]
    },
    {
      id: "strategic-2026",
      year: "2026",
      ...
      highlights: ["Less Competition", "More Impact", "Fashion Systems"]
    },
    {
      id: "upcoming-targets",
      year: "2026/2027",
      ...
      highlights: ["Mr. Chuka University Target", "Mr. Blue Economy Target", "National Platform"]
    }
  ],
  ...
  skills: {
    ...
    backend: ["Node.js", "Express", "Supabase", "REST APIs", "GraphQL"],
    data: ["Statistics", "Econometrics", "Data Analysis", "Machine Learning", "Quantitative Finance"],
    design: ["Figma", "UI/UX", "3D Modeling", "WebGL", "Shader Programming"],
    tools: ["Git", "GitHub", "VSCode", "Vercel", "Docker", "Jupyter"]
  },
  ...
  site: {
    ...
    skillFeatures: [
      { id: 'research', title: 'Research', desc: 'Economics & Data Analysis', icon: 'Cpu' },
      { id: 'modeling', title: 'Modeling', desc: 'Statistical & Predictive', icon: 'LineChart' },
      { id: 'tech', title: 'Technology', desc: 'Full-Stack Development', icon: 'Code' },
