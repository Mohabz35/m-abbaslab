    ...
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 border-b border-gray-200 dark:border-gray-800 pb-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Train your AI Chatbot and WhatsApp bot on custom keywords and rules.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <h3 className="text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-2">Trained Knowledge Base</h3>
          
          {rules.length === 0 ? (
            <div className="p-8 border border-gray-200 dark:border-gray-700 border-dashed border-gray-300 dark:border-gray-700 rounded-xl text-center text-gray-500 dark:text-gray-400">
              No knowledge rules trained yet. Add rules on the right to start training!
            </div>
          ) : (
            <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
              {rules.map((rule, idx) => (
                <div key={idx} className="p-4 bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-gray-700 border-gray-150 dark:border-white/5 rounded-xl flex flex-col justify-between gap-3">
                  {editingIndex === idx ? (
                    <div className="space-y-3 w-full">
                      <div>
                        <label className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold">Keyword Trigger</label>
                        <input
                          value={editKeyword}
                      ...
                      <div>
                        <label className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold">Jarvis Custom Response</label>
                        <textarea
                          value={editResponse}
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex gap-1">
                          <button
                            ...
                            className="p-1.5 hover:bg-gray-200 dark:hover:bg-gray-800 rounded-lg text-gray-500 dark:text-gray-400 hover:text-blue-500 transition-colors"
                          >
                            <Edit className="w-4 h-4" />
                          </button>
                          <button
                            onClick={() => handleDeleteRule(idx)}
                            className="p-1.5 hover:bg-gray-200 dark:hover:bg-gray-800 rounded-lg text-gray-500 dark:text-gray-400 hover:text-red-500 transition-colors"
                          >
                            <Trash2 className="w-4 h-4" />
                          </button>
                        </div>
                      </div>
                      <p className="text-sm text-gray-700 dark:text-gray-400 dark:text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800/50 dark:bg-black/20 p-3 rounded-lg border border-gray-200 dark:border-gray-700 border-gray-150 dark:border-white/5">
                        {rule.response}
                      </p>
                    </>
                  )}
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400">Add New Training Rule</h3>
          
          <div className="bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-gray-700 border-gray-150 dark:border-white/5 rounded-2xl p-5 space-y-4">
            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Trigger Keyword</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Jarvis Reply</label>
              <textarea
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 dark:bg-black/40 border border-gray-200 dark:border-gray-700 border-gray-150 dark:border-white/5 rounded-2xl p-5 space-y-4 shadow-sm">
              <div>
                <label className="block text-xs font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Active Mode</label>
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    >
                      ...
                      <div className="text-[9px] text-gray-400 dark:text-gray-500 dark:text-gray-400 mt-0.5 leading-tight">{mode.desc}</div>
                    </button>
                  ))}
                </div>
              </div>
              ...
              {schedule.type !== 'always' && schedule.type !== 'disabled' && (
                <div className="grid grid-cols-2 gap-3 p-3 bg-white dark:bg-gray-800/50 dark:bg-black/20 rounded-xl border border-gray-200 dark:border-gray-700 border-gray-150 dark:border-white/5 animate-fadeIn">
                  <div>
                    <label className="block text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold mb-1">Start Time</label>
                    <input
                      type="time"
                  ...
                  <div>
                    <label className="block text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold mb-1">End Time</label>
                    <input
                      type="time"
              ...
              <div>
                <label className="block text-xs font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Timezone</label>
                <select
                ...
                <div className="mt-1 flex items-center gap-1 text-[9px] text-gray-400 dark:text-gray-500 dark:text-gray-400">
