...
export default function SystemSettings() {
  ...
  if (loading) {
    return <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 text-gray-400">Loading configuration...</div>
  }
        ...
        <div className="bg-gray-950 p-5 rounded-xl border border-gray-800">
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center justify-between text-sm text-gray-300">
              ...
              <input type="number" step="0.01" value={config.worldQuant.riskTolerance} onChange={e => setConfig({ ...config, worldQuant: { ...config.worldQuant, riskTolerance: parseFloat(e.target.value) } })} className="w-20 bg-gray-900 border border-gray-700 rounded px-2 py-1 outline-none focus:border-blue-500" />
            </label>
            <label className="flex items-center justify-between text-sm text-gray-300">
              <span>Backtest Duration (Years)</span>
              <input type="number" value={config.worldQuant.backtestYears} onChange={e => setConfig({ ...config, worldQuant: { ...config.worldQuant, backtestYears: parseInt(e.target.value) } })} className="w-20 bg-gray-900 border border-gray-700 rounded px-2 py-1 outline-none focus:border-blue-500" />
            </label>
          </div>
        </div>
        ...
        <div className="bg-gray-950 p-5 rounded-xl border border-gray-800">
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between text-sm text-gray-300">
              ...
              <input type="text" value={config.finance.defaultCurrency} onChange={e => setConfig({ ...config, finance: { ...config.finance, defaultCurrency: e.target.value } })} className="w-20 bg-gray-900 border border-gray-700 rounded px-2 py-1 outline-none focus:border-blue-500" />
            </label>
            <label className="flex items-center justify-between text-sm text-gray-300">
              <span>Tax Rate (%)</span>
              <input type="number" step="0.1" value={config.finance.taxRate} onChange={e => setConfig({ ...config, finance: { ...config.finance, taxRate: parseFloat(e.target.value) } })} className="w-20 bg-gray-900 border border-gray-700 rounded px-2 py-1 outline-none focus:border-blue-500" />
            </label>
            <label className="flex items-center justify-between text-sm text-gray-300">
              <span>Savings Target (%)</span>
              <input type="number" value={config.finance.savingsTargetPercent} onChange={e => setConfig({ ...config, finance: { ...config.finance, savingsTargetPercent: parseInt(e.target.value) } })} className="w-20 bg-gray-900 border border-gray-700 rounded px-2 py-1 outline-none focus:border-blue-500" />
            </label>
          </div>
        </div>
        ...
        <div className="bg-gray-950 p-5 rounded-xl border border-gray-800">
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between text-sm text-gray-300">
              ...
              <select value={config.fashion.defaultSizing} onChange={e => setConfig({ ...config, fashion: { ...config.fashion, defaultSizing: e.target.value } })} className="bg-gray-900 border border-gray-700 rounded px-2 py-1 outline-none focus:border-blue-500">
            ...
            <label className="flex items-center justify-between text-sm text-gray-300">
              ...
              <input type="number" value={config.fashion.lowStockThreshold} onChange={e => setConfig({ ...config, fashion: { ...config.fashion, lowStockThreshold: parseInt(e.target.value) } })} className="w-20 bg-gray-900 border border-gray-700 rounded px-2 py-1 outline-none focus:border-blue-500" />
            </label>
          </div>
        </div>
      </div>
