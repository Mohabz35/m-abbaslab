    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <button
          ...
          className="self-start inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border border-gray-200 dark:border-gray-800 text-xs font-semibold text-gray-700 dark:text-gray-400 dark:text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-900 rounded-xl p-4 border border-gray-200 dark:border-gray-700 border-gray-100 dark:border-gray-800 shadow-sm">
          <div className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider">Total Groups</div>
          <div className="text-xl font-bold text-gray-900 dark:text-white mt-1">{stats.totalGroups}</div>
        </div>
        <div className="bg-white dark:bg-gray-900 rounded-xl p-4 border border-gray-200 dark:border-gray-700 border-gray-100 dark:border-gray-800 shadow-sm">
          <div className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider">Monitored Groups</div>
          <div className="text-xl font-bold text-blue-600 dark:text-blue-400 mt-1">{stats.monitoredGroups}</div>
        </div>
        <div className="bg-white dark:bg-gray-900 rounded-xl p-4 border border-gray-200 dark:border-gray-700 border-gray-100 dark:border-gray-800 shadow-sm">
          <div className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider">Statuses Analyzed</div>
          <div className="text-xl font-bold text-purple-600 dark:text-purple-400 mt-1">{stats.totalStatuses}</div>
        </div>
        <div className="bg-white dark:bg-gray-900 rounded-xl p-4 border border-gray-200 dark:border-gray-700 border-gray-100 dark:border-gray-800 shadow-sm">
          <div className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider">Auto-Likes Sent</div>
      ...
      <div>
        {isLoading ? (
          <div className="py-12 flex justify-center items-center">
            ...
            <span className="ml-3 text-sm text-gray-500 dark:text-gray-400">Loading details...</span>
          </div>
        ) : (
          <>
            {/* Groups Tab */}
            {subTab === 'groups' && (
              <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                <div className="p-4 bg-gray-50 dark:bg-gray-800/40 border-b border-gray-200 dark:border-gray-700 border-gray-150 dark:border-gray-800">
                  <h4 className="text-sm font-bold text-gray-700 dark:text-gray-400 dark:text-gray-600 dark:text-gray-300">WhatsApp Groups Discovered</h4>
                </div>
                {groups.length === 0 ? (
                  ...
                  <div className="divide-y divide-gray-150 dark:divide-gray-800">
                    {groups.map(group => {
                      ...
                      return (
                        <div key={group.group_jid} className="p-4 flex items-center justify-between hover:bg-gray-50 dark:bg-gray-800/50/50 dark:hover:bg-gray-800/20 transition-colors">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <button
                              ...
                              className={`p-1.5 rounded-lg border border-gray-200 dark:border-gray-700 transition-all ${
                                monitored
            ...
            {subTab === 'statuses' && (
              <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                <div className="p-4 bg-gray-50 dark:bg-gray-800/40 border-b border-gray-200 dark:border-gray-700 border-gray-150 dark:border-gray-800">
                  <h4 className="text-sm font-bold text-gray-700 dark:text-gray-400 dark:text-gray-600 dark:text-gray-300">WhatsApp Status Analytics Log</h4>
                </div>
                {statuses.length === 0 ? (
                  <div className="p-8 text-center text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <div className="divide-y divide-gray-150 dark:divide-gray-800 max-h-[600px] overflow-y-auto">
                    {statuses.map(status => {
                      ...
                      return (
                        <div key={status.id} className="p-4 space-y-2 hover:bg-gray-50 dark:bg-gray-800/50/50 dark:hover:bg-gray-800/20 transition-colors">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-400 dark:text-gray-600 dark:text-gray-300">
                                {getCategoryIcon(category)}
                                <span className="capitalize ml-1">{category}</span>
                              </span>

                              {isLiked && (
                                <span className="inline-flex items-center gap-0.5 px-2 py-0.5 rounded-full text-xs font-semibold bg-rose-50 dark:bg-rose-950/20 text-rose-600 dark:text-rose-400 border border-gray-200 dark:border-gray-700 border-rose-100 dark:border-rose-900">
                          ...
                          <div className="text-sm text-gray-800 dark:text-gray-200 bg-gray-50 dark:bg-gray-950 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700 border-gray-100 dark:border-gray-850">
                            <div className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Status Content</div>
                          ...
                          <div className="text-xs text-gray-500 dark:text-gray-400 flex items-start gap-1">
                            <MessageSquare className="w-3.5 h-3.5 text-gray-500 dark:text-gray-400 mt-0.5 flex-shrink-0" />
                            <div>
                              <span className="font-bold text-gray-600 dark:text-gray-500 dark:text-gray-400">Jarvis analysis: </span>
                              {analysis}
                            </div>
                          </div>
                        </div>
            ...
            {subTab === 'settings' && (
              <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 space-y-6">
                ...
                <div className="space-y-4">
                  {/* Group Monitoring */}
                  <div className="flex items-center justify-between p-4 rounded-xl border border-gray-200 dark:border-gray-700 border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-950">
                    <div className="space-y-1">
