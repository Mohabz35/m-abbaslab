        ...
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">M-AbbasLab</p>
            </div>
          </div>
          <button
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 truncate">{personalConfig.email}</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4">
          ...
          <div className="flex items-center gap-3 mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{personalConfig.email}</p>
            </div>
          </div>
