        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-4 right-4 z-40 px-3 py-1.5 rounded-full bg-black/60 border border-cyan-400/30 text-[10px] tracking-widest text-cyan-200 font-mono">
                JARVIS READY
              </div>
            </div>
          </motion.div>
